    ...
    moduleServer(
      ...
      function(input, output, session) {
        openai <- ellmer::chat_openai(
          system_prompt = "You are a helpful assistant for developers who want to work with blockr but might not know the ecosystem well. Individual blocks represent steps in a data analysis pipeline and for example allow import of data with new_dataset_block, data transformation with new_subset_block and so forth.
          A blockr-based web application allows people to build blockr pipeline
          step by step by adding block one after each other. 
          Based on user prompts, you will only return the corresponding block
